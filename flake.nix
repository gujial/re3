{
  description = "Flake for building re3 (GTA III) master branch";
    ...
    let
      ...
      buildRe3 =
        ...
        pkgs.stdenv.mkDerivation rec {
          ...
          meta = with pkgs.lib; {
            description = "Re3 master branch: the mainline GTA III engine port built with CMake, OpenAL, and libRW.";
